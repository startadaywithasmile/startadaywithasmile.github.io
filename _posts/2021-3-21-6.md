...
#感谢 [DIYgod](https://github.com/DIYgod)    [nIceLee](https://github.com/nICEnnnnnnnLee)

[metowolf](https://github.com/metowolf)     [Duter2016](https://github.com/Duter2016)

#网上很少涉及Jekyll引用Aplayer 或是 MetingJSr 插件的， 有的也是用CDN。 
...
* MetingJSr 本地歌单 的插件 还没写

* iOS 6.1.3 浏览器不适配 Aplayer 和 MetingJSr 
...
<!-- require APlayer -->
<link rel="stylesheet" href="/ipa picture/css/APlayer.min.css">
<div id="player1" apname1="{{ page.apname1 }}" apartist="{{ page.apartist1 }}" apurl1="{{ page.apurl1 }}" apcover1="{{ page.apcover1 }}" aplrc1="{{ page.aplrc1 }}" apname2="{{ page.apname2 }}" apartist2="{{ page.apartist2 }}" apurl2="{{ page.apurl2 }}" apcover2="{{ page.apcover2 }}" aplrc2="{{ page.aplrc2 }}" class="aplayer"></div>
<script src="/ipa picture/js/APlayer.min.js"></script> 
...
#### MetingJSr 音乐单曲/音乐歌单 链接 本地单曲 四缺一插件 （这周写本地歌单插件）
----
...
![Vincent van Gogh - Starry Night Over the Rhone](/ipa picture/6/Starry Night Over the Rhone - Vincent van Gogh.JPG)
